  ...
  try {
    ...
    const items = await Promise.all(itemsSnap.docs.map(async (itemDoc) => {
      ...
      return {
        ...
        fabric_details: itemData.custom_fabric_details || (garmentData ? garmentData.fabric_details : null),
        fabric_finish: itemData.custom_fabric_finish || (garmentData ? garmentData.fabric_finish : null),
        care_instructions: itemData.custom_care_instructions || (garmentData ? garmentData.care_instructions : null),
        fit: itemData.custom_fit || (garmentData ? garmentData.fit : null),
        fabric_weight_gsm: itemData.custom_fabric_weight_gsm || (garmentData ? garmentData.fabric_weight_gsm : null),
        decoration_method: itemData.custom_decoration_method || (garmentData ? garmentData.decoration_method : null),
        sizes: itemData.custom_sizes || (garmentData ? garmentData.sizes : null),
        available_colors: itemData.custom_available_colors || (garmentData ? garmentData.available_colors : null),
